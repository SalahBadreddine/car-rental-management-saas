...
const SignUp = () => {
  ...
  if (user) {
    ...
    return <Navigate to={role === "client" ? "/client/location-select" : "/enduser/vehicles"} replace />
  }
    ...
    try {
      const res = await fetch("http://localhost:3000/auth/signup", {
        ...
        body: JSON.stringify({
          ...
          role: role === "client" ? "admin" : "customer",
        }),
      })
        ...
        <div className="max-w-lg w-full p-8 bg-white/10 backdrop-blur-sm rounded-xl shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                I agree to the{" "}
                <span className="text-primary hover:text-primary/80 cursor-pointer">Terms and Policy</span>
              </label>
            </div>
