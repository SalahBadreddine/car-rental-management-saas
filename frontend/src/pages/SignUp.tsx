    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-7xl">
          <div
            className="relative rounded-3xl overflow-hidden bg-hero-bg"
            style={{
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        className="bg-white/10 border-white/20 text-white placeholder:text-white/60 focus:border-white/40 h-11"
                      />
                    </div>
