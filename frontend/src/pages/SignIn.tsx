...
const SignIn = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // we will handle sign in logic here later ...
  };
        ...
        <HeroBackground trace={traceCar} car={heroCar}>
          ...
          <div className="relative z-10 p-8 md:p-16 min-h-[600px] flex items-center">
            <div className="w-full max-w-xl">
              <div className="bg-form-bg/70 backdrop-blur-sm rounded-2xl p-8 md:p-10 shadow-2xl min-h-[500px] flex flex-col justify-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-white/10 border-white/80 text-white placeholder:text-white/60 focus:border-white/40 h-12"
                    />
                  </div>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-base rounded-lg mt-2"
                  >
                    Sign in
                  </Button>
                </form>
